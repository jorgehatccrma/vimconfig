...
" Edit window
call SetHi("Normal",          { 'bg': 233, 'fg': 254})
call SetHi("Cursor",          { 'bg':  34, 'fg': 254})
call SetHi("LineNr",          { 'bg':   0, 'fg': 244})
call SetHi("EndOfBuffer",     { 'bg': 233, 'fg': 246})
call SetHi("CursorLine",      { 'bg': 234, 'usenone': 1})
call SetHi("CursorColumn",    { 'bg': 234})
call SetHi("CursorLineNr",    { 'fg': 39})
call SetHi("ColorColumn",     { 'bg': 235})
call SetHi("Visual",          { 'bg': 28, 'fg': 15, 'usenone': 1})

" Gutter
call SetHi("FoldColumn",      { 'bg': 0, 'fg': 244})
call SetHi("Folded",          { 'bg': 235, 'fg': 246})
call SetHi("SignColumn",      { 'bg': 0, 'fg': 244})

" Window / Tabs
call SetHi("VertSplit",       { 'bg': 0, 'fg': 28, 'usenone': 1})
call SetHi("TabLine",         { 'bg': 22, 'fg': 254})
call SetHi("TabLine",         { 'bg': 0, 'fg': 254, 'usenone': 1})
call SetHi("TabLineSel",      { 'bg': 28, 'fg': 254})

" File Navigation / Searching
call SetHi("Search",          { 'bg': 178, 'fg': 233})
call SetHi("IncSearch",       { 'bg': 34, 'fg': 254})
call SetHi("Directory",       { 'fg': 39, 'usenone': 1})

" Autocomplete menu
call SetHi("Pmenu",           { 'bg': 246, 'fg': 0})
call SetHi("PmenuSel",        { 'bg': 22, 'fg': 76})

" Wildmenu/bufferline
call SetHi("WildMenu",        { 'bg': 28, 'fg': 118, 'usenone': 1})
call SetHi("StatusLine",      { 'bg': 22, 'fg': 249, 'usenone': 1})
call SetHi("StatusLineNC",    { 'bg': 28, 'fg': 118, 'usenone': 1})

call SetHi("SpellBad",        { 'bg': 125, 'fg': 230})
call SetHi("MatchParen",      { 'bg': 172, 'fg': 246})
...
call SetHi("Comment", {'fg': 246})

call SetHi("Constant", {'fg': 127})
call SetHi("String", {'fg': 172})
hi   link   Character    String
call SetHi("Float", {'fg': 39})
...
call SetHi("Type", {'fg': 113})
" SetHi("StorageClass", {})
" SetHi("Structure", {})
" SetHi("Typedef", {})

call SetHi("Special", {'fg': 105})
" SetHi("SpecialChar", {})
" SetHi("Tag", {})
" SetHi("Delimiter", {})
...
call SetHi("Underlined", {'fg': 220})

" SetHi("Ignore", {})

"  palette red is too bright for background
call SetHi("Error", {'bg': 124})
...
call SetHi("mkdCode", {'bg': 237, 'fg': 220})
...
call SetHi("InactiveBuffer", {'bg': 238, 'fg': 246, 'usenone': 1})
